...
#   1 - WhiteRiver Tools of Citizenship Quest Pack
...
git_clone https://github.com/XelaNull/7DTD-WhiteRiver_ToC-combined.git

#   2- Zombie Lootbag Increase
...
#  3-  60slot Bag, Faster Bellows, and Increase Headshot Damage
...
#     4- Increased Headshot Damage - Slightly increases the damage when making headshots
svn_checkout "https://github.com/XelaNull/7DTD-Bag_Bellows_Headshot/trunk/Headshot_15"
#   5- Magazine_Plants_Trader
...
#   6- Pickup Plants - Allows you to press E to pickup plants (not compatible with living off the land)
svn_checkout "https://github.com/XelaNull/7DTD-Magazine_Plants_Trader/trunk/Pickup_Plants"
...
########Irgit_clone https://github.com/XelaNull/HOME_DEPOT_7D2D_MOD.git
...
wget_download https://cdgroup.org/files/7dtd/TerrainBasedMovementSpeed.zip TerrainBasedMovementSpeed.zip extract_file
...
# Log Spikes
svn_checkout "https://github.com/XelaNull/7dtd-FixedModlets/trunk/LogSpikes"
# H7SB Storage
...
#   Buff Infection
svn_checkout "https://github.com/doughphunghus/7D2D-Doughs-Mods-a20/trunk/Doughs-Buff-Infection"
#   Add More Pipe Bomb Variety
svn_checkout "https://github.com/doughphunghus/7D2D-Doughs-Mods-a20/trunk/Doughs-Buff-PipeBombs"
#   Add more Grenade Variety 2020-02
svn_checkout "https://github.com/doughphunghus/7D2D-Doughs-Mods-a20/trunk/Doughs-Buff-Grenades"
#   Sous Chef of the Apocalypse
svn_checkout "https://github.com/doughphunghus/7D2D-Doughs-Mods-a20/trunk/Doughs-Food-SousChefOfTheApocalypse"
#   Nerf Flashlights and Player Crafted Lanterns - Harder to craft and find
svn_checkout "https://github.com/doughphunghus/7D2D-Doughs-Mods-a20/trunk/Doughs-Nerf-FlashlightsAndLanterns"
...
######svn_checkout "https://github.com/doughphunghus/7D2D-Doughs-Mods-a20/trunk/Doughs-PunishingWeather-Core"
######svn_checkout "https://github.com/doughphunghus/7D2D-Doughs-Mods-a20/trunk/Doughs-PunishingWeather-Effects-Light"
#   Add five ingredients option to UI
######svn_checkout "https://github.com/doughphunghus/7D2D-Doughs-Mods-a20/trunk/Doughs-UIAddFiveRecipeIngredients"
#   You’ve Got Mail
...
# 39 - JaxTeller718's Modlets
#   Eggs In Fridges
git_clone https://github.com/JaxTeller718/A20ModletsJax
rm -rf $MODCOUNT/A20ModletsJax/JaxTeller718-A* \
       $MODCOUNT/A20ModletsJax/JaxTeller718-Birds* \
       $MODCOUNT/A20ModletsJax/JaxTeller718-Blood* \
       $MODCOUNT/A20ModletsJax/JaxTeller718-C* \
       $MODCOUNT/A20ModletsJax/JaxTeller718-D* \
       $MODCOUNT/A20ModletsJax/JaxTeller718-F* \
       $MODCOUNT/A20ModletsJax/JaxTeller718-H* \
       $MODCOUNT/A20ModletsJax/JaxTeller718-IncreasedM* \
       $MODCOUNT/A20ModletsJax/JaxTeller718-IncreasedZombiesx3 \
       $MODCOUNT/A20ModletsJax/JaxTeller718-IncreasedZombiesx4* \
       $MODCOUNT/A20ModletsJax/JaxTeller718-J* \
       $MODCOUNT/A20ModletsJax/JaxTeller718-N* \
       $MODCOUNT/A20ModletsJax/JaxTeller718-W* \
       $MODCOUNT/A20ModletsJax/JaxTeller718-Z*
# svn_checkout "https://github.com/JaxTeller718/A20ModletsJax/trunk/JaxTeller718_EggsInFridges"
#   Bigger Random Wandering Hordes
# svn_checkout "https://github.com/JaxTeller718/A20ModletsJax/trunk/JaxTeller718_BiggerWanderingHordes"
#   Increased Wilderness Zombies
# svn_checkout "https://github.com/JaxTeller718/A20ModletsJax/trunk/JaxTeller718_IncreasedBiomeZombiesx2"
#   Slower Levelling
# svn_checkout "https://github.com/JaxTeller718/A20ModletsJax/trunk/JaxTeller718_SlowerProgression"
...
gdrive_download 127CYhMekuGuJ2PSUd3CSAUmNerbA1nfb FGStainlessModA20.zip extract_file

# Realistic Silencer
# https://drive.google.com/file/d/1v2ANaC27PIfvwcgirQPUrRnDWjrDhyIC/view?usp=sharing
########gdrive_download 1v2ANaC27PIfvwcgirQPUrRnDWjrDhyIC RealsticSilencersA20.rar extract_file

# Saminal's Deco Stuff
git_clone https://github.com/saminal1/samsmods-a20.git
rm -rf $MODCOUNT/samsmods-a20/SA* \
       $MODCOUNT/samsmods-a20/SB* \
       $MODCOUNT/samsmods-a20/SC* \
       $MODCOUNT/samsmods-a20/SE* \
       $MODCOUNT/samsmods-a20/SH* \
       $MODCOUNT/samsmods-a20/SK* \
       $MODCOUNT/samsmods-a20/SL* \
       $MODCOUNT/samsmods-a20/SO* \
       $MODCOUNT/samsmods-a20/SR* \
       $MODCOUNT/samsmods-a20/SS* \
       $MODCOUNT/samsmods-a20/ST* \
       $MODCOUNT/samsmods-a20/SW*

# Riles Modlets
#   Fixes (Adds countless server fixes back to the game)
# Not updated for A20, and not tested yet
#######gdrive_download 1q1MdS4kRRu94S22KXcDqfiiZbXW4ZTZs RilesFixes.zip extract_file
#   HUDPlus (Adds a custom UI)
# Replaced with Origin UI?
...
#   Deco Blocks
## Not Updated for A20 yet... not tested either
